          ...
          <div className="mx-auto grid max-w-[40rem] grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-5">
            <div className="flex flex-col lg:pb-6 lg:col-span-2 justify-center">
              ...
              <p className="mt-6 text-base leading-7 text-slate-700">
                It doesn&#39;t matter if you have an API if nobody knows how to use it. Teach people
                the ins and outs of OAuth 2.0 and JWTs in style with Protocol, a beautiful API
            ...
            <div className="relative lg:col-span-3">
              <Image
                ...
                alt="banner"
                fill
                className="!h-[430px] relative z-20 -mb-36 aspect-[853/682] !max-w-full rounded-xl bg-slate-200 shadow-xl shadow-black/5 ring-1 ring-slate-900/5 sm:-mb-16 lg:-mb-8 xl:-mb-16"
              />
            </div>
          </div>
        </div>
